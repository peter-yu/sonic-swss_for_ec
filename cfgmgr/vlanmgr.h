...
private:
    ...
    bool setEbtablesRule(const std::string &chain_name, const std::string port_alias, bool is_add);
    void updateVlanMemberEbTablesRule(int vlan_id, const std::string port_alias, bool is_add);
};
